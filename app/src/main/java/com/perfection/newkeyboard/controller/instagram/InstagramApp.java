package com.perfection.newkeyboard.controller.instagram;
...
/**
 * Created by Divya Thakur on 21-08-2017.
 */
...
public class InstagramApp {
            ...
            public void run() {
                ...
                try {
                    ...
                    String name = jsonObj.getJSONObject("user").getString(
                            "full_name");
                    profilePicture = jsonObj.getJSONObject("user").getString("profile_picture");
        ...
        new Thread() {
            ...
            public void run() {
                ...
                try {
                    ...
                    Log.e("PROFILE_PIC", data_obj.getString(TAG_PROFILE_PICTURE));
    ...
    public String getTagProfilePicture() {return profilePicture;}
